...
export const FOOTER_COLUMNS = [
  {
    ...
    links: [
      ...
      { href: '/during-production-inspection/', label: 'During-Production Inspection' },
      { href: '/production-monitoring-india/', label: 'Production Monitoring' },
      { href: '/packaging-transit-validation/', label: 'Packaging & Transit' },
      { href: '/supplier-shortlisting/', label: 'Supplier Shortlisting' },
      { href: '/monsoon-watch/', label: 'Monsoon Watch' },
  ...
  },
  {
    ...
    links: [
      ...
      { href: '/buyers/', label: 'Who We Protect' },
      { href: '/why-independent/', label: 'Why Independent' },
      { href: '/contact/', label: 'Contact' },
    ],
  },
